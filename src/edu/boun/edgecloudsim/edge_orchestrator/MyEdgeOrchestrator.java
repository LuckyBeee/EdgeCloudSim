...
public class MyEdgeOrchestrator extends EdgeOrchestrator {
	...
	private int numberOfTasksOffloaded;
	...
	public MyEdgeOrchestrator(String _policy, String _simScenario) {
	...
	public int getNumberOfTasksOffloaded() {
		return numberOfTasksOffloaded;
	}
	
	public int getSizeOfTaskIDList() {
		return taskIDS.size();
	}
}